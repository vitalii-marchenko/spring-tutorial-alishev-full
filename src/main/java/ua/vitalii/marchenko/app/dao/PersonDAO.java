package ua.vitalii.marchenko.app.dao;
...
public class PersonDAO {
    ...
    public Optional<Person> show(final String email) {
        return jdbcTemplate.query("SELECT * FROM Person WHERE email=?", new Object[]{email}, new BeanPropertyRowMapper<>(Person.class)).stream()
                .findAny();
    }
